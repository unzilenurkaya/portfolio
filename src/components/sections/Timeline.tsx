...
export default function Timeline() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'work':
        return 'from-accent-lime to-green-500';
      default:
  ...
  const getTypeBorderColor = (type: string) => {
    switch (type) {
      ...
      case 'work':
        return 'border-accent-lime/30 hover:border-accent-lime/50';
      default:
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px md:-translate-x-px">
            ...
            <motion.div
              className="absolute inset-x-0 h-full bg-gradient-to-b from-primary via-secondary to-accent-cyan"
              initial={{ scaleY: 0 }}
            ...
            />
            {/* Neon Glow */}
            <div className="absolute inset-x-0 h-full bg-gradient-to-b from-primary via-secondary to-accent-cyan blur-sm opacity-50" />
          </div>
